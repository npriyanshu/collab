export const productiveList = [
  {
    title: "Boards",
    desc: "Collab boards keep tasks organized and work moving forward. In a glance, see everything from “things to do” to “aww yeah, we did it!”",
    img: "/productive_1.jpg",
  },
  {
    title: "Lists",
    desc: "The different stages of a task. Start as simple as To Do, Doing or Done—or build a workflow custom fit to your team’s needs. There’s no wrong way to Collab.",
...
export const workflowList = [
  {
    ...
    desc: "Keep tasks in order, deadlines on track, and team members aligned with Collab.",
    img: "/workflow_1.png",
    color: "bg-[#ff7452]",
  },
  {
  ...
  {
    title: "Onboarding",
    desc: "Onboarding to a new company or project is a snap with Collab’s visual layout of to-do’s, resources, and progress tracking.",
    img: "/workflow_3.png",
    color: "bg-[#57d9a3]",
  },
  {
    title: "Task management",
    desc: "Use Collab to track, manage, complete, and bring tasks together like the pieces of a puzzle, and make your team’s projects a cohesive success every time.",
    img: "/workflow_4.png",
    color: "bg-[#ffc400]",
  },
  {
